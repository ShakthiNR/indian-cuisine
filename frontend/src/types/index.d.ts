...
export interface IRecipe {
  ...
  export interface IItemLists {
      ...
      setDebounceTimeout: React.Dispatch<React.SetStateAction<NodeJS.Timeout | null>>,
      page: number
  }

  export interface IItemFilter {
      searchQuery: string,
      handleSearchChange: (event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, newValue?: string) => void,
      dietFilter: string,
